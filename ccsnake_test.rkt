...
(check-exn #rx"Invalid direction" (lambda () (next (game (list 0 1 2 3) HEAD_START RIGHT 0))))
(check-exn #rx"Invalid direction" (lambda () (next (game (list 112 111 110 109) HEAD_END RIGHT 0))))
(check-exn #rx"Invalid direction" (lambda () (next (game (list 106 141 176 211 210) HEAD_END RIGHT 0))))
(check-exn #rx"Invalid direction" (lambda () (next (game (list 105 106 141 176 211) HEAD_START RIGHT 0))))
(check-exn #rx"Invalid direction" (lambda () (next (game (list 3 2 1 0) HEAD_START LEFT 0))))
(check-exn #rx"Invalid direction" (lambda () (next (game (list 0 1 2 3) HEAD_END LEFT 0))))
(check-exn #rx"Invalid direction" (lambda () (next (game (list 105 140 175 210 106) HEAD_END LEFT 0))))
(check-exn #rx"Invalid direction" (lambda () (next (game (list 211 105 140 175 210) HEAD_START LEFT 0))))
(check-exn #rx"Invalid direction" (lambda () (next (game (list 105 140 175 210) HEAD_END UP 0))))
(check-exn #rx"Invalid direction" (lambda () (next (game (list 210 105 140 175) HEAD_START UP 0))))
(check-exn #rx"Invalid direction" (lambda () (next (game (list 35 3 2 1 0) HEAD_START UP 0))))
(check-exn #rx"Invalid direction" (lambda () (next (game (list 3 2 1 0 38) HEAD_END UP 0))))
(check-exn #rx"Invalid direction" (lambda () (next (game (list 105 140 175 210) HEAD_START DOWN 0))))
(check-exn #rx"Invalid direction" (lambda () (next (game (list 210 175 140 105) HEAD_END DOWN 0))))
(check-exn #rx"Invalid direction" (lambda () (next (game (list 3 38 37 36 35) HEAD_START DOWN 0))))
(check-exn #rx"Invalid direction" (lambda () (next (game (list 38 37 36 35 0) HEAD_END DOWN 0))))
