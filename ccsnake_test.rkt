...
(check-equal? (render (make-game empty 0 0)) (place-images/align (list (text (string-append SCORE_STRING (number->string 0))
...
(check-equal? (render (make-game (list 0 1 2 3) 1 0))
...
(check-equal? (render (make-game (list 3 4 5 6) 1 0)) 
              (place-images/align (list (text (string-append SCORE_STRING (number->string 0))
                                              SCORE_SIZE SCORE_COLOR)
                                        (rectangle GRID_WIDTH GRID_HEIGHT "outline" GRID_BORDER_COLOR)
                                        (square CELL_WIDTH "solid" "green")
...
(check-equal? (render (make-game (list 31 32 33 34) 1 0))
              (place-images/align (list (text (string-append SCORE_STRING (number->string 0))
                                              SCORE_SIZE SCORE_COLOR)
                                        (rectangle GRID_WIDTH GRID_HEIGHT "outline" GRID_BORDER_COLOR)
                                        (square CELL_WIDTH "solid" "green")
                                  ...
                                  "left" "top" BACKGROUND))
(check-equal? (render (make-game (list 35 36 37 38) 1 0))
              (place-images/align (list (text (string-append SCORE_STRING (number->string 0))
                                              SCORE_SIZE SCORE_COLOR)
                                        (rectangle GRID_WIDTH GRID_HEIGHT "outline" GRID_BORDER_COLOR)
                                        (square CELL_WIDTH "solid" "green")
                                  ...
                                  "left" "top" BACKGROUND))
(check-equal? (render (make-game (list 38 39 40 41) 1 0))
              (place-images/align (list (text (string-append SCORE_STRING (number->string 0))
                                              SCORE_SIZE SCORE_COLOR)
                                        (rectangle GRID_WIDTH GRID_HEIGHT "outline" GRID_BORDER_COLOR)
                                        (square CELL_WIDTH "solid" "green")
                                  ...
                                  "left" "top" BACKGROUND))
(check-equal? (render (make-game (list 66 67 68 69) 1 0)) 
              (place-images/align (list (text (string-append SCORE_STRING (number->string 0))
                                              SCORE_SIZE SCORE_COLOR)
                                        (rectangle GRID_WIDTH GRID_HEIGHT "outline" GRID_BORDER_COLOR)
                                        (square CELL_WIDTH "solid" "green")
...
(check-equal? (render (make-game (list 31 32 33 34) 1 0)) 
              (place-images/align (list (text (string-append SCORE_STRING (number->string 0))
                                  ...
                                  (list (make-posn SCORE_X SCORE_Y)
                                        ...
                                        (make-posn (+ (* CELL_WIDTH 31) (* CELL_WIDTH 3)) GRID_Y))
                                  "left" "top" BACKGROUND))
(check-equal? (render (make-game (list 1155 1156 1157 1158) 1 0))
              (place-images/align (list (text (string-append SCORE_STRING (number->string 0))
                                              SCORE_SIZE SCORE_COLOR)
                                        (rectangle GRID_WIDTH GRID_HEIGHT "outline" GRID_BORDER_COLOR)
                                        (square CELL_WIDTH "solid" "green")
                                  ...
                                  "left" "top" BACKGROUND))
(check-equal? (render (make-game (list 1158 1159 1160 1161) 1 0)) 
              (place-images/align (list (text (string-append SCORE_STRING (number->string 0))
                                              SCORE_SIZE SCORE_COLOR)
                                        (rectangle GRID_WIDTH GRID_HEIGHT "outline" GRID_BORDER_COLOR)
                                        (square CELL_WIDTH "solid" "green")
                                  ...
                                  "left" "top" BACKGROUND))
(check-equal? (render (make-game (list 1186 1187 1188 1189) 1 0)) 
              (place-images/align (list (text (string-append SCORE_STRING (number->string 0))
                                              SCORE_SIZE SCORE_COLOR)
                                        (rectangle GRID_WIDTH GRID_HEIGHT "outline" GRID_BORDER_COLOR)
                                        (square CELL_WIDTH "solid" "green")
...
(check-equal? (render (make-game (list 0 35 70 105) 1 0))
              (place-images/align (list (text (string-append SCORE_STRING (number->string 0))
                                              SCORE_SIZE SCORE_COLOR)
                                        (rectangle GRID_WIDTH GRID_HEIGHT "outline" GRID_BORDER_COLOR)
                                        (square CELL_WIDTH "solid" "green")
...
(check-equal? (render (make-game (list 0 1 2 3) 0 0))
              (place-images/align (list (text (string-append SCORE_STRING (number->string 0))
                                              SCORE_SIZE SCORE_COLOR)
                                        (rectangle GRID_WIDTH GRID_HEIGHT "outline" GRID_BORDER_COLOR)
                                        (square CELL_WIDTH "solid" "seagreen")
...
(check-equal? (render (make-game (list 3 4 5 6) 0 0)) 
              (place-images/align (list (text (string-append SCORE_STRING (number->string 0))
                                              SCORE_SIZE SCORE_COLOR)
                                        (rectangle GRID_WIDTH GRID_HEIGHT "outline" GRID_BORDER_COLOR)
                                        (square CELL_WIDTH "solid" "seagreen")
...
(check-equal? (render (make-game (list 31 32 33 34) 0 0))
              (place-images/align (list (text (string-append SCORE_STRING (number->string 0))
                                              SCORE_SIZE SCORE_COLOR)
                                        (rectangle GRID_WIDTH GRID_HEIGHT "outline" GRID_BORDER_COLOR)
                                        (square CELL_WIDTH "solid" "seagreen")
                                  ...
                                  (list (make-posn SCORE_X SCORE_Y)
                                        ...
                                        (make-posn (+ (* CELL_WIDTH 31) (* CELL_WIDTH 3)) GRID_Y))
                                  "left" "top" BACKGROUND))
(check-equal? (render (make-game (list 35 36 37 38) 0 0))
              (place-images/align (list (text (string-append SCORE_STRING (number->string 0))
                                              SCORE_SIZE SCORE_COLOR)
                                        (rectangle GRID_WIDTH GRID_HEIGHT "outline" GRID_BORDER_COLOR)
                                        (square CELL_WIDTH "solid" "seagreen")
                                  ...
                                  (list (make-posn SCORE_X SCORE_Y)
                                        ...
                                        (make-posn (+ GRID_X (* CELL_WIDTH 3)) (+ GRID_Y CELL_WIDTH)))
                                  "left" "top" BACKGROUND))
(check-equal? (render (make-game (list 38 39 40 41) 0 0))
              (place-images/align (list (text (string-append SCORE_STRING (number->string 0))
                                              SCORE_SIZE SCORE_COLOR)
                                        (rectangle GRID_WIDTH GRID_HEIGHT "outline" GRID_BORDER_COLOR)
                                        (square CELL_WIDTH "solid" "seagreen")
                                  ...
                                  (list (make-posn SCORE_X SCORE_Y)
                                        ...
                                        (make-posn (+ (* CELL_WIDTH 3) (* CELL_WIDTH 3)) (+ GRID_Y CELL_WIDTH)))
                                  "left" "top" BACKGROUND))
(check-equal? (render (make-game (list 66 67 68 69) 0 0)) 
              (place-images/align (list (text (string-append SCORE_STRING (number->string 0))
                                              SCORE_SIZE SCORE_COLOR)
                                        (rectangle GRID_WIDTH GRID_HEIGHT "outline" GRID_BORDER_COLOR)
                                        (square CELL_WIDTH "solid" "seagreen")
...
(check-equal? (render (make-game (list 31 32 33 34) 0 0)) 
              (place-images/align (list (text (string-append SCORE_STRING (number->string 0))
                                  ...
                                  (list (make-posn SCORE_X SCORE_Y)
                                        ...
                                        (make-posn (+ (* CELL_WIDTH 31) (* CELL_WIDTH 3)) GRID_Y))
                                  "left" "top" BACKGROUND))
(check-equal? (render (make-game (list 1155 1156 1157 1158) 0 0))
              (place-images/align (list (text (string-append SCORE_STRING (number->string 0))
                                              SCORE_SIZE SCORE_COLOR)
                                        (rectangle GRID_WIDTH GRID_HEIGHT "outline" GRID_BORDER_COLOR)
                                        (square CELL_WIDTH "solid" "seagreen")
                                  ...
                                  (list (make-posn SCORE_X SCORE_Y)
                                        ...
                                        (make-posn (+ GRID_X (* CELL_WIDTH 3)) (+ GRID_Y (* CELL_WIDTH 33))))
                                  "left" "top" BACKGROUND))
(check-equal? (render (make-game (list 1158 1159 1160 1161) 0 0)) 
              (place-images/align (list (text (string-append SCORE_STRING (number->string 0))
                                              SCORE_SIZE SCORE_COLOR)
                                        (rectangle GRID_WIDTH GRID_HEIGHT "outline" GRID_BORDER_COLOR)
                                        (square CELL_WIDTH "solid" "seagreen")
                                  ...
                                  (list (make-posn SCORE_X SCORE_Y)
                                        ...
                                        (make-posn (+ (* CELL_WIDTH 3) (* CELL_WIDTH 3)) (+ GRID_Y (* CELL_WIDTH 33))))
                                  "left" "top" BACKGROUND))
(check-equal? (render (make-game (list 1186 1187 1188 1189) 0 0)) 
              (place-images/align (list (text (string-append SCORE_STRING (number->string 0))
                                              SCORE_SIZE SCORE_COLOR)
                                        (rectangle GRID_WIDTH GRID_HEIGHT "outline" GRID_BORDER_COLOR)
                                        (square CELL_WIDTH "solid" "seagreen")
...
(check-equal? (render (make-game (list 0 35 70 105) 0 0))
              (place-images/align (list (text (string-append SCORE_STRING (number->string 0))
                                              SCORE_SIZE SCORE_COLOR)
                                        (rectangle GRID_WIDTH GRID_HEIGHT "outline" GRID_BORDER_COLOR)
                                        (square CELL_WIDTH "solid" "seagreen")
...
(check-equal? (render (make-game (list 143 144 145 146 181 216 251 286) 0 0))
              (place-images/align (list (text (string-append SCORE_STRING (number->string 0))
                                              SCORE_SIZE SCORE_COLOR)
                                        (rectangle GRID_WIDTH GRID_HEIGHT "outline" GRID_BORDER_COLOR)
                                        (square CELL_WIDTH "solid" "seagreen")
...
(check-equal? (render (make-game (list 143 144 145 146 181 216 251 286) 1 0))
              (place-images/align (list (text (string-append SCORE_STRING (number->string 0))
                                              SCORE_SIZE SCORE_COLOR)
                                        (rectangle GRID_WIDTH GRID_HEIGHT "outline" GRID_BORDER_COLOR)
                                        (square CELL_WIDTH "solid" "green")
