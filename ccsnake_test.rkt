...
(check-equal? (next (game (list 0 1 2 3) 1 0 0)) (game (list 1 2 3 4) 1 0 0))
(check-equal? (next (game (list 31 32 33 34) 0 2 0)) (game (list 30 31 32 33) 0 2 0))
(check-equal? (next (game (list 105 140 175 210) 0 3 0)) (game (list 70 105 140 175) 0 3 0))
(check-equal? (next (game (list 105 140 175 210) 1 1 0)) (game (list 140 175 210 245) 1 1 0))
(check-equal? (next (game (list 110 145 180 215) 0 0 0)) (game (list 111 110 145 180) 0 0 0))
(check-exn #rx"Illegal move" (lambda () (next (game (list 0 1 2 3) 0 0 0))))
(check-equal? (next (game (list 111 110 145 180) 0 0 0)) (game (list 112 111 110 145) 0 0 0))
(check-equal? (next (game (list 112 111 110 145 180) 0 0 0)) (game (list 113 112 111 110 145) 0 0 0))
(check-equal? (next (game (list 112 111 110 145) 0 0 0)) (game (list 113 112 111 110) 0 0 0))
